...
// getSessionData();
// returns value of any session data
	function getSessionData(){
		var get_vars = $.param(arguments);
		var session_id= $('meta[name=zen_session_id]').attr("content");
		get_vars = get_vars + '&session_id=' + session_id ;		
		$.get('global/scripts/js/getSessionData.php', get_vars,
			function(data){
				alert(data);	
			}			
		);
